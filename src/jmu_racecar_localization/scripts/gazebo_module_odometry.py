...
class OdometryNode:
    # Set publishers
    # pub_odom = rospy.Publisher('/jmu_racecar_gazebo/odom', Odometry, queue_size=1)
    pub_odom = rospy.Publisher('/gazebo_module_odom', Odometry, queue_size=1)
    # pub_odom = rospy.Publisher('/gazebo_odom', Odometry, queue_size=1)
