...
def get_add_vels(speed_add_once,turn_add_once):
...
if __name__=="__main__":
    ...
    try:
     ...
     #       elif key == ' ' or key == 'k' :
                ...
                run = 0   
            print get_vels(control_speed,control_turn)  
            print get_add_vels(speed_bias,turn_bias)  
            print "-----------------------------------------" 
            ...
            if(run == 1):                      
                ...
                msg.drive.steering_angle_velocity = control_turn;
                pub.publish(msg);
