...
class A_star_path:
    def __init__(self):
        # TODO gazebo_odom 
        # self.current_pose = rospy.Subscriber('/jmu_racecar_gazebo/odom', Odometry, self.callback_read_current_position, queue_size=1)
        ...
        self.control_input = rospy.Publisher('/racecar/ackermann_cmd', AckermannDriveStamped, queue_size=1)
        self.Pose = []
        self.start_id = []
        self.Goal = []
        self.path = []
